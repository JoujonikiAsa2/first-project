...
exports.createFacultyValidationSchema = zod_1.z.object({
    body: zod_1.z.object({
        ...
        faculty: zod_1.z.object({
            ...
            gender: zod_1.z.enum([...fauclty_constant_1.Gender]),
            dateOfBirth: zod_1.z.string().optional(),
            email: zod_1.z.string().email(),
            contactNo: zod_1.z.string(),
            emergencyContactNo: zod_1.z.string(),
            bloodGroup: zod_1.z.enum([...fauclty_constant_1.BloodGroup]),
...
exports.updateFacultyValidationSchema = zod_1.z.object({
    body: zod_1.z.object({
        faculty: zod_1.z.object({
            ...
            gender: zod_1.z.enum([...fauclty_constant_1.Gender]).optional(),
            dateOfBirth: zod_1.z.string().optional(),
            email: zod_1.z.string().email().optional(),
            contactNo: zod_1.z.string().optional(),
            emergencyContactNo: zod_1.z.string().optional(),
            bloodGroup: zod_1.z.enum([...fauclty_constant_1.BloodGroup]).optional(),
