...
const academiSemesterSchema = new mongoose_1.Schema({
    name: {
        type: String,
        required: true,
...
academiSemesterSchema.pre('save', function (next) {
...
exports.AcademicSemester = (0, mongoose_1.model)('AcademicSemester', academiSemesterSchema);
